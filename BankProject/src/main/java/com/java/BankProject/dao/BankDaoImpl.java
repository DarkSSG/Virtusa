...
public class BankDaoImpl implements BankDao {
  ...
  @Override
  public String createAccount(Account account) throws SQLException, ClassNotFoundException {
  ...
  @Override
  public Account searchAccount(int accountNo) throws SQLException, ClassNotFoundException {
    conn = ConnectionHelper.getConnection();
  ...
  public String depositAccount(int accountNo, double amount) throws SQLException, ClassNotFoundException {
    Account accounts = searchAccount(accountNo);
    if (accounts !=null){

      conn = ConnectionHelper.getConnection();

      // checking the STATUS
      String checkSql = "SELECT Status FROM Accounts WHERE AccountNo = ?";
      ...
      if (rs.getString("Status").equalsIgnoreCase("inactive")) {
        return "Account is inactive. Deposit not allowed.";
      }
  ...
  public String withdrawAccount(int accountNo, double amount) throws SQLException, ClassNotFoundException {
    ...
    if (accounts !=null){
      ...
      if (rs.getString("Status").equalsIgnoreCase("inactive")) {
        return "Account is inactive. Withdrawal not allowed.";
      }
